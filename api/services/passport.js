...
passport.connect = function (req, query, profile, next) {
  ...
  if (profile.hasOwnProperty('provider') && profile.provider == 'google' && profile.hasOwnProperty('photos')) {
    user.photoUrl = profile.photos[0].value;
  }else if (profile.hasOwnProperty('provider') && profile.provider == 'facebook' && profile.hasOwnProperty('id')) {
    user.photoUrl = 'http://graph.facebook.com/'+profile.id+'/picture';
  }
